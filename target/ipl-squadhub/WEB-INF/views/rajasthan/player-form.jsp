...
<head>
    <meta charset="UTF-8">
    <title>Rajasthan Royals - Player Form</title>
        ...
        <div class="col-md-6">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-info text-white text-center fw-bold">
                    <c:choose>
                        <c:when test="${mode eq 'edit'}">
                            Modify Rajasthan Player
                        </c:when>
                        <c:otherwise>
                            Add Rajasthan Player
                        </c:otherwise>
                    </c:choose>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="<c:url value='/rajasthan/save'/>" method="post">
                        ...
                        <div class="d-flex justify-content-center gap-3 mt-4">
                            ...
                            <a href="<c:url value='/rajasthan/list'/>"
