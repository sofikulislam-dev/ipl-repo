    ...
    <c:choose>
        ...
        <c:when test="${not empty player}">
                ...
                <div class="card-body p-0">
                    ...
                    <table class="table table-striped table-hover mb-0 text-center">
                        ...
                        <c:forEach var="plr" items="${player}">
                            <tr>
                                <td>
                                    <a href="<c:url value='/kolkata/player/${plr.id}'/>"
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="<c:url value='/kolkata/edit?id=${plr.id}'/>"
                                           class="btn btn-sm btn-outline-warning">
                                            Edit
                                        </a>

                                        <a href="<c:url value='/kolkata/delete?id=${plr.id}'/>"
            ...
            <div class="text-center mt-4 d-flex justify-content-center gap-3">
                <a href="<c:url value='/kolkata/add'/>"
