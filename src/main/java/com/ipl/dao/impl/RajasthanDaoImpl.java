...
@Repository
public class RajasthanDaoImpl implements RajasthanDao {

    private final JdbcTemplate jdbcTemplate;

    public RajasthanDaoImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Player> getAll() {
        String sql = "select * from rajasthan";
        return jdbcTemplate.query(sql, rowMapper);
    }

    @Override
    public Player findById(int id) {
        String sql = "select * from rajasthan where id =?";
        return jdbcTemplate.queryForObject(sql, rowMapper, id);
    }

    @Override
    public void save(Player player) {
        String sql = "insert into rajasthan(id, name, age, role, matches, strike, price, runs, nationality) " +
                "values(?,?,?,?,?,?,?, ?, ?)";
    ...
    public void update(Player player) {
        ...
        String sql = "update rajasthan set name=?, age=?, role=?, matches=?, " +
    ...
    public void delete(int id) {
        String sql = "delete from rajasthan where id = ?";
