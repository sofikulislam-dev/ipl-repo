...
@Repository
public class KolkataDaoImpl implements KolkataDao {

    private final JdbcTemplate jdbcTemplate;

    public KolkataDaoImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Player> getAll() {
        String sql = "select * from kolkata";
        return jdbcTemplate.query(sql, rowMapper);
    }

    @Override
    public Player findById(int id) {
        String sql = "select * from kolkata where id =?";
        return jdbcTemplate.queryForObject(sql, rowMapper, id);
    }

    @Override
    public void save(Player player) {
        String sql = "insert into kolkata(id, name, age, role, matches, strike, price, runs, nationality) " +
                "values(?,?,?,?,?,?,?, ?, ?)";
    ...
    public void update(Player player) {
        ...
        String sql = "update kolkata set name=?, age=?, role=?, matches=?, " +
    ...
    public void delete(int id) {
        String sql = "delete from kolkata where id = ?";
