...
@Repository
public class MumbaiDaoImpl implements MumbaiDao {

    private final JdbcTemplate jdbcTemplate;

    public MumbaiDaoImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Player> getAll() {
        String sql = "select * from mumbai";
        return jdbcTemplate.query(sql, rowMapper);
    }

    @Override
    public Player findById(int id) {
        String sql = "select * from mumbai where id =?";
        return jdbcTemplate.queryForObject(sql, rowMapper, id);
    }

    @Override
    public void save(Player player) {
        String sql = "insert into mumbai(id, name, age, role, matches, strike, price, runs, nationality) " +
                "values(?,?,?,?,?,?,?, ?, ?)";
    ...
    public void update(Player player) {
        ...
        String sql = "update mumbai set name=?, age=?, role=?, matches=?, " +
    ...
    public void delete(int id) {
        String sql = "delete from mumbai where id = ?";
