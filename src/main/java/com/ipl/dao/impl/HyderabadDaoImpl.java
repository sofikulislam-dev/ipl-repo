...
@Repository
public class HyderabadDaoImpl implements HyderabadDao {

    private final JdbcTemplate jdbcTemplate;

    public HyderabadDaoImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Player> getAll() {
        String sql = "select * from hyderabad";
        return jdbcTemplate.query(sql, rowMapper);
    }

    @Override
    public Player findById(int id) {
        String sql = "select * from hyderabad where id =?";
        return jdbcTemplate.queryForObject(sql, rowMapper, id);
    }

    @Override
    public void save(Player player) {
        String sql = "insert into hyderabad(id, name, age, role, matches, strike, price, runs, nationality) " +
                "values(?,?,?,?,?,?,?, ?, ?)";
    ...
    public void update(Player player) {
        ...
        String sql = "update hyderabad set name=?, age=?, role=?, matches=?, " +
    ...
    public void delete(int id) {
        String sql = "delete from hyderabad where id = ?";
