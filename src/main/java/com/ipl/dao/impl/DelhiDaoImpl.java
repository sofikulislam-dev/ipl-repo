...
@Repository
public class DelhiDaoImpl implements DelhiDao {

    private final JdbcTemplate jdbcTemplate;

    public DelhiDaoImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Player> getAll() {
        String sql = "select * from delhi";
        return jdbcTemplate.query(sql, rowMapper);
    }

    @Override
    public Player findById(int id) {
        String sql = "select * from delhi where id =?";
        return jdbcTemplate.queryForObject(sql, rowMapper, id);
    }

    @Override
    public void save(Player player) {
        String sql = "insert into delhi(id, name, age, role, matches, strike, price, runs, nationality) " +
                "values(?,?,?,?,?,?,?, ?, ?)";
    ...
    public void update(Player player) {
        ...
        String sql = "update delhi set name=?, age=?, role=?, matches=?, " +
    ...
    public void delete(int id) {
        String sql = "delete from delhi where id = ?";
